...
echo "=== run: dump FIFO RSX ==="
PS3_VFS_ROOT="/c/Users/softlive/Documents/self-projects/gow2_work/extracted" PS3_RSX_DUMP=1 PS3_SEM_SPIN_BREAK=4096 PS3_SYSUTIL_BOOT=1 PS3_SYSUTIL_CB_OPD=0x524288 PS3_SYSUTIL_SINGLETON=0x6FF480 timeout -k 3 12 ./boot_hle.exe ../EBOOT.ELF > rsx.out 2> rsx.err
echo "exit=$?"
echo "=== [RSX] FIFO capturado ==="
grep -aE "^\[RSX\]|fifo\[" rsx.err | head -80
echo FIM
