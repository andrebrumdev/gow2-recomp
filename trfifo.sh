...
echo "=== run: dump FIFO real (FORCE_GCMINIT) ==="
PS3_VFS_ROOT="/c/Users/softlive/Documents/self-projects/gow2_work/extracted" PS3_VM_LOW_MB=384 PS3_VM_STACK_MB=64 PS3_FORCE_GCMINIT=1 PS3_BUILD_SINGLETON=1 PS3_SEM_SPIN_BREAK=4096 PS3_RSX_DUMP=1 timeout -k 3 12 ./boot_hle.exe ../EBOOT.ELF > ff.out 2> ff.err
echo "exit=$?"
echo "=== [RSX] FIFO real capturado ==="; grep -aE "^\[RSX\]|fifo\[" ff.err | head -70
echo FIM
