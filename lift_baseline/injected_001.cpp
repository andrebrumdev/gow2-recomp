...
extern "C" void ps3_host_wad_tex_capture(const char* name, uint32_t buf, uint32_t size);
extern "C" int ppu_guest_range_committed(uint32_t addr, uint32_t n);
